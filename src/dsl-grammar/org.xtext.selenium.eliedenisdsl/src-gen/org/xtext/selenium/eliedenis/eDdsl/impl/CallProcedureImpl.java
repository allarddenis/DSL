 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.selenium.eliedenis.eDdsl.impl.CallProcedureImpl#getProcedureName <em>Procedure Name</em>}</li>
 *   <li>{@link org.xtext.selenium.eliedenis.eDdsl.impl.CallProcedureImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CallProcedureImpl extends InstructionImpl implements CallProcedure
{
  ...
  {
    return EDdslPackage.Literals.CALL_PROCEDURE;
  }
  ...
  public void setProcedureName(String newProcedureName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EDdslPackage.CALL_PROCEDURE__PROCEDURE_NAME, oldProcedureName, procedureName));
  }
  ...
  public EList<String> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EDataTypeEList<String>(String.class, this, EDdslPackage.CALL_PROCEDURE__PARAMETERS);
    }
    return parameters;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EDdslPackage.CALL_PROCEDURE__PROCEDURE_NAME:
        return getProcedureName();
      case EDdslPackage.CALL_PROCEDURE__PARAMETERS:
