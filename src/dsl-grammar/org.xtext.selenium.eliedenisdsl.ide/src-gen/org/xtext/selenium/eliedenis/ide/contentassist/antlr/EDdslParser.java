		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTestAccess().getProceduresAssignment_0(), "rule__Test__ProceduresAssignment_0");
					put(grammarAccess.getTestAccess().getMainAssignment_1(), "rule__Test__MainAssignment_1");
